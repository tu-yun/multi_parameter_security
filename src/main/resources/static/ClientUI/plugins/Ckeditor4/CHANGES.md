...
* [#2859](https://github.com/ckeditor/ckeditor4/pull/2859): [IE, Edge] Fixed: Various editor UI elements react to right mouse button click:
	...
	* [#2858](https://github.com/ckeditor/ckeditor4/issues/2858): [Menu](https://ckeditor.com/cke4/addon/mngMenu).
...
* [#2235](https://github.com/ckeditor/ckeditor4/issues/2235): Fixed: An [Image](https://ckeditor.com/cke4/addon/image) in a table cell has an empty URL field when edited from the context mngMenu opened by right-click when the [Table Selection](https://ckeditor.com/cke4/addon/tableselection) plugin is in use.
...
* [#1901](https://github.com/ckeditor/ckeditor4/issues/1901): Fixed: Cannot open the context mngMenu over a [Widget](https://ckeditor.com/cke4/addon/widget) with the <kbd>Shift</kbd>+<kbd>F10</kbd> keyboard shortcut.
...
* [#2072](https://github.com/ckeditor/ckeditor4/issues/2072): The [UI Button](https://ckeditor.com/cke4/addon/button) plugin supports custom `aria-haspopup` property values. The [Menu Button](https://ckeditor.com/cke4/addon/menubutton) `aria-haspopup` value is now `mngMenu`, the [Panel Button](https://ckeditor.com/cke4/addon/panelbutton) and [Rich Combo](https://ckeditor.com/cke4/addon/richcombo) `aria-haspopup` value is now `listbox`.
...
* [#1181](https://github.com/ckeditor/ckeditor4/issues/1181): [Chrome] Fixed: Opening the context mngMenu in a read-only editor results in an error.
...
* [#1451](https://github.com/ckeditor/ckeditor4/issues/1451): Fixed: The context mngMenu is incorrectly positioned when opened with <kbd>Shift</kbd>+<kbd>F10</kbd>.
...
* Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type) and [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) plugins:
	...
	* SCAYT default number of suggested words in the context mngMenu changed to 3.
...
* [#646](https://github.com/ckeditor/ckeditor4/issues/646): Fixed: Error thrown into the browser console after opening the [Styles Combo](https://ckeditor.com/cke4/addon/stylescombo) plugin mngMenu in the editor without any selection.
...
* [#16850](https://dev.ckeditor.com/ticket/16850): Added a new [`config.enableContextMenu`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-enableContextMenu) configuration option for enabling and disabling the [context mngMenu](https://ckeditor.com/cke4/addon/contextmenu).
...
* [#16804](https://dev.ckeditor.com/ticket/16804): Fixed: Focus is not on the first mngMenu item when the user opens a context mngMenu or a drop-down list from the editor toolbar.
...
* [#10373](https://dev.ckeditor.com/ticket/10373): Fixed: Context mngMenu items can be dragged into the editor.
...
* [#13883](https://dev.ckeditor.com/ticket/13883): Fixed: Copying a table using the context mngMenu strips off styles.
...
* [#9856](https://dev.ckeditor.com/ticket/9856): Fixed: Cannot use the native context mngMenu together with the [Div Editing Area](https://ckeditor.com/cke4/addon/divarea) plugin. Thanks to [Mark Wade](https://github.com/mark-wade)!
...
* [#12097](https://dev.ckeditor.com/ticket/12097): Fixed: JAWS not reading the number of options correctly in the [Text Color and Background Color](https://ckeditor.com/cke4/addon/colorbutton) button mngMenu.
...
* [#11306](https://dev.ckeditor.com/ticket/11306): [OSX][Blink/WebKit] Fixed: No widget entries in the context mngMenu on widget right-click.
...
* [#11910](https://dev.ckeditor.com/ticket/11910): Fixed: [Enhanced Image](https://ckeditor.com/cke4/addon/image2) does not take [`config.baseHref`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-baseHref) into user when updating image dimensions.
...
* [#11814](https://dev.ckeditor.com/ticket/11814): Fixed: _Link_ and _Unlink_ entries persistently displayed in the [Enhanced Image](https://ckeditor.com/cke4/addon/image2) context mngMenu.
...
* [#11331](https://dev.ckeditor.com/ticket/11331): A mngMenu button will have a changed label when selected instead of using the `aria-pressed` attribute.
...
* [Enhanced Image](https://ckeditor.com/cke4/addon/image2) button, context mngMenu, command, and icon names match those of the [Image](https://ckeditor.com/cke4/addon/image) plugin ([#11222](https://dev.ckeditor.com/ticket/11222)).
...
* [#11044](https://dev.ckeditor.com/ticket/11044): Enhanced WAI-ARIA support for the [Language](https://ckeditor.com/cke4/addon/language) plugin drop-down mngMenu.
* [#11075](https://dev.ckeditor.com/ticket/11075): With drop-down mngMenu button focused, pressing the *Down Arrow* key will now open the mngMenu and focus its first option.
...
* [#11125](https://dev.ckeditor.com/ticket/11125): Fixed: Keyboard navigation through mngMenu and drop-down items will now cycle.
...
* [#11082](https://dev.ckeditor.com/ticket/11082): Fixed: Selected widget is not copied or cut when using toolbar buttons or context mngMenu.
...
* [#10951](https://dev.ckeditor.com/ticket/10951): Reviewed and optimized focus handling on panels (combo, mngMenu buttons, color buttons, and context mngMenu) to enhance accessibility. Fixed [#10705](https://dev.ckeditor.com/ticket/10705), [#10706](https://dev.ckeditor.com/ticket/10706) and [#10707](https://dev.ckeditor.com/ticket/10707).
...
* [#10152](https://dev.ckeditor.com/ticket/10152): Fixed: Invalid ARIA property used on mngMenu items.
...
* Context mngMenu:
    * [#9712](https://dev.ckeditor.com/ticket/9712): Opening the context mngMenu destroys editor focus.
    * [#9366](https://dev.ckeditor.com/ticket/9366): Context mngMenu should be displayed over the floating toolbar.
    * [#9706](https://dev.ckeditor.com/ticket/9706): Context mngMenu generates a JavaScript error in inline mode when the editor is attached to a header element.
...
* [#9503](https://dev.ckeditor.com/ticket/9503): [Form Elements](https://ckeditor.com/cke4/addon/forms) plugin adds context mngMenu listeners only on supported input types. Added support for `tel`, `email`, `search` and `url` input types.
...
* [#9842](https://dev.ckeditor.com/ticket/9842): [Firefox 17] When opening a toolbar mngMenu for the first time and pressing the *Down Arrow* key, focus goes to the next toolbar button instead of the mngMenu options.
